        ...
        try:
            ...
            if current_activity is not None:
                ...
                if current_activity["media_type"] == "episode":
                    to_send = dict(
                        state=current_activity["parent_title"].replace(
                            "Season", "Saison"
                        )
                        + " - Épisode "
                ...
                # Musics
                    ...
                    if len(current_activity["title"]) > 25:
                        ...
                        to_send = dict(
                            state=current_activity["title"] + " ー " + artists
                        )
                    to_send["large_image"] = "music"
                    to_send["details"] = (
                        playing_or_not + current_activity["parent_title"]
                    )
                # Others
                else:
                ...
                if (
                    ...
                    to_send["details"] = (
                        playing_or_not + current_activity["grandparent_title"]
                    )
